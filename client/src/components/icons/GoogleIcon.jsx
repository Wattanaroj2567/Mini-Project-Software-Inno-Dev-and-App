...
// This mimics the CSS snippet you shared but as a React component.
export default function GoogleIcon({ size = 25, style, ...props }) {
  ...
  return (
    <span
      ...
      style={{
        ...
        width: size,
        height: size,
        background: `url('${dataUrl}') 50% 50% / 100% 100% no-repeat`,
        ...style,
      }}
      {...props}
    />
